...
def evaluate_estimator(estimator, X_train, Y_train):
    ...
    for cv_index in range(CV_NUM):
        cv_object = StratifiedKFold(Y_train,
                                    n_folds=N_FOLDS,
                                    shuffle=True,
...
def generate_prediction(X_train,
                        Y_train,
                        X_test,
                        optimal_parameters,
    ...
    optimal_estimator = XGBClassifier(max_depth=optimal_max_depth,
    ...
    cv_object = StratifiedShuffleSplit(Y_train,
                                       n_iter=1,
