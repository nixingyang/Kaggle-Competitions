...
def load_data():
    ...
    for current_column_name in combined_file_content.columns.values:
        current_column_array = combined_file_content[
            current_column_name].as_matrix()
    ...
    print("{:d} constant columns removed.".format(
        len(invalid_column_name_list)))
