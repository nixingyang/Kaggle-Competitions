...
ACTUAL_DATASET_FOLDER_PATH = os.path.join(WORKSPACE_FOLDER_PATH,
                                          "actual_dataset")
ACTUAL_CROPPED_TRAIN_FOLDER_PATH = os.path.join(ACTUAL_DATASET_FOLDER_PATH,
                                                "cropped_train")
ACTUAL_CROPPED_VALID_FOLDER_PATH = os.path.join(ACTUAL_DATASET_FOLDER_PATH,
                                                "cropped_valid")
...
def reorganize_dataset():
    ...
    return len(glob.glob(os.path.join(
        ACTUAL_CROPPED_TRAIN_FOLDER_PATH, "*/*"))), len(
...
def run():
    ...
    train_generator = load_dataset(ACTUAL_CROPPED_TRAIN_FOLDER_PATH,
                                   classes=unique_label_list,
                                   class_mode="categorical",
                                   shuffle=True)
    valid_generator = load_dataset(ACTUAL_CROPPED_VALID_FOLDER_PATH,
                                   classes=unique_label_list,
                                   class_mode="categorical",
                                   shuffle=True)
