...
def augment_and_mix(image, severity, width, depth, alpha, all_operations=False):
    ...
    Args:
        ...
        all_operations: Turn on all operations (+brightness,contrast,color,sharpness).
...
class AugMix(ImageOnlyTransform):
    ...
    def apply(self, image, severity, width, depth, alpha, all_operations,
              **params):  # pylint: disable=arguments-differ
        return augment_and_mix(image, severity, width, depth, alpha,
                               all_operations)
    ...
    def get_transform_init_args_names(self):
        return ("severity", "width", "depth", "alpha", "all_operations")
